...
date: "*`r paste0('Stand: ', format(Sys.time(), '%d.%m.%Y'))`*"
---
...
* <a class="index-link" href="#m25">Übermittlung und Offenbarung von personenbezogenen Daten</a>
...
* **WEB.DE Homepage & Mail:** Hostingplattform für Websites; Dienstanbieter: 1&1 Mail & Media GmbH, Brauerstr. 48, 76135 Karlsruhe, Deutschland; Website: <a href="https://www.web.de" target="_blank">https://www.web.de</a>; Datenschutzerklärung: <a href="https://agb-server.web.de/mdh-dsgvo" target="_blank">https://agb-server.web.de/mdh-dsgvo</a>.</li></ul><h3 id="m12">
